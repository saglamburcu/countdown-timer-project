# COUNTDOWN TIMER
A countdown timer exists in this project. According to the giveaway date, this countdown timer is updated. It shows a remaining day, hour, minute, and second to the giveaway date.
...
```
git clone https://github.com/saglamburcu/countdown-timer-project.git
```
